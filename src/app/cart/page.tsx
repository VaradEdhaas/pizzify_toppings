...
export default function CartPage() {
    ...
    const { cart, isLoading, addToCart, removeFromCart } = useCart(userId || "");
            ...
            <BackgroundBeamsWithCollision>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-7xl mx-auto mb-15">
                    ...
                    <div className="md:col-span-2 space-y-5" ref={cartRef}>
                        {localCart.map((item) =>
                            item.productId ? (
                                ...
                                >
                                    <CardContent className="flex flex-col sm:flex-row sm:items-start justify-between gap-5 p-4 sm:p-5">
                                        {/* Left - Product Image */}
                                        <img
                                            src={item.productId.imageUrl || "/placeholder.png"}
                                            alt={item.productId.name}
                                            className="w-20 h-20 object-cover rounded-xl border border-white/10 shadow-sm"
                                        />
                                        ...
                                        <div className="flex flex-col justify-between items-end gap-3 min-w-[100px]">
                                            ...
                                            {/* Bottom - Total Price */}
                                            <span className="text-green-400 font-semibold text-sm self-end">
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl p-6 h-fit shadow-lg">
                        ...
                        <Button variant="classic" colorVariant="gray" className="w-full cursor-pointer">
                            Checkout
                        </Button>
                    </div>
                </div>
