...
import { Avatar as NextUIAvatar, type AvatarProps as NextUIAvatarProps } from "@nextui-org/react"
...
const AvatarFallback = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "flex h-full w-full items-center justify-center rounded-full bg-white/10 text-white font-light",
        className,
      )}
      {...props}
    />
